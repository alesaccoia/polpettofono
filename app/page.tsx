...
type SoundZone = { id: string; name: string; color: string; x: number; y: number; radius: number; file: string };

const zones: SoundZone[] = [
  { id: 'miao', name: 'Miao', color: '#ff6b4a', x: 49, y: 64, radius: 12, file: '/audio/meow.ogg' },
  { id: 'fusa', name: 'Fusa', color: '#f4ba37', x: 50, y: 83, radius: 15, file: '/audio/purr.ogg' },
  { id: 'chiamata', name: 'Chiamata', color: '#54c7b7', x: 50, y: 46, radius: 15, file: '/audio/cat-call.ogg' },
  { id: 'gorgheggio', name: 'Gorgheggio', color: '#9776f2', x: 24, y: 67, radius: 20, file: '/audio/chirp.wav' },
];
